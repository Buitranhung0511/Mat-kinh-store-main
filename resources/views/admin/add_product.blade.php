<<<<<<< HEAD=======>>>>>>> 9c735972c689d92533ceabb863e55a922c0aaa2f
    <?php
    
    use Illuminate\Support\Facades\Session;
    ?>

    <<<<<<< HEAD @extends('admin_layout') @section('admin_content')=======@extends('admin_layout') @section('admin-content')>>>>>>>
                            ...
                            <form name="myForm1" role="form" action="{{ URL::to('/save-product') }}" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="product_name"
                                        id="exampleInputEmail1" data-validation="length" data-validation-length="min3">
                                </div>
